...
public class FrameLessXxlJobConfig_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.xxl.job.executor.sample.frameless.config.FrameLessXxlJobConfig"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.xxl.job.core.executor.impl.XxlJobSimpleExecutor", false, FrameLessXxlJobConfig_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(FrameLessXxlJobConfig_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FrameLessXxlJobConfig_SSTest_scaffolding.class.getClassLoader()); 
